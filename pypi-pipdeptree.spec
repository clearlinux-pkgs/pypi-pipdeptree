...
Source0  : https://files.pythonhosted.org/packages/9b/e6/ccebfbb786e3804446ec35e336e5ebcb91e8f5a50e193e04eba8d74c11b2/pipdeptree-2.25.0.tar.gz
...
%prep
%setup -q -n pipdeptree-2.25.0
cd %{_builddir}/pipdeptree-2.25.0
pushd ..
cp -a pipdeptree-2.25.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737992477
