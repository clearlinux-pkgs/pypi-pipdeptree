...
Source0  : https://files.pythonhosted.org/packages/74/ef/9158ee3b28274667986d39191760c988a2de22c6321be1262e21c8a19ccf/pipdeptree-2.26.1.tar.gz
...
%prep
%setup -q -n pipdeptree-2.26.1
cd %{_builddir}/pipdeptree-2.26.1
pushd ..
cp -a pipdeptree-2.26.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745245360
