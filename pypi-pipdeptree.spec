...
Source0  : https://files.pythonhosted.org/packages/6a/ad/108aa2c69632c929d83d2f23a9621b08649a284540829d228bc394d6b0f1/pipdeptree-2.13.2.tar.gz
...
%prep
%setup -q -n pipdeptree-2.13.2
cd %{_builddir}/pipdeptree-2.13.2
pushd ..
cp -a pipdeptree-2.13.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704986784
