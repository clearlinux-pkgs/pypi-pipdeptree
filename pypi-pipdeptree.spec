...
Source0  : https://files.pythonhosted.org/packages/f1/22/af4f7e301cf70dc5ecb6f25366122f3925637013376971e2356ebde82695/pipdeptree-2.16.2.tar.gz
...
%prep
%setup -q -n pipdeptree-2.16.2
cd %{_builddir}/pipdeptree-2.16.2
pushd ..
cp -a pipdeptree-2.16.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711464499
