...
Source0  : https://files.pythonhosted.org/packages/2b/1f/9bbf4f001befee00c050051f8f6e7971b41e2716784949989c7e856bf625/pipdeptree-2.23.1.tar.gz
...
%prep
%setup -q -n pipdeptree-2.23.1
cd %{_builddir}/pipdeptree-2.23.1
pushd ..
cp -a pipdeptree-2.23.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720800009
