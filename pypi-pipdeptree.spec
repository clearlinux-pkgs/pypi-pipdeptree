...
Source0  : https://files.pythonhosted.org/packages/d5/4c/a9e8e5820f066185f392e64bd4a5335d5bdbe5d26871985f1122fb1c53ef/pipdeptree-2.23.3.tar.gz
...
%prep
%setup -q -n pipdeptree-2.23.3
cd %{_builddir}/pipdeptree-2.23.3
pushd ..
cp -a pipdeptree-2.23.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725749185
